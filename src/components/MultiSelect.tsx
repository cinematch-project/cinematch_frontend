...
import { CheckIcon, ChevronsUpDown, WandSparkles, XCircle, XIcon } from "lucide-react";
 ...
 */
const multiSelectVariants = cva("m-px transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const arraysEqual = React.useCallback((a: Array<string>, b: Array<string>): boolean => {
              ...
              {selectedValues.length > 0 ? (
                <div className="flex w-full items-center justify-between">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-1 h-4 w-4 cursor-pointer rounded-sm hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                                  "h-3 w-3",
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronsUpDown className="cursor-pointer opacity-50" aria-hidden="true" />
                  </div>
                </div>
              ) : (
                <>
